...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val a = Animal(name="Jerry", old=3, long=555, optionStr = Some("hello"))
    val bytes = encode(a)
...
final case class Animal(@N(1) name: String, @N(33) long: Long, @N(2) old: Int, @N(4) optionStr: Option[String])
case object Dog
